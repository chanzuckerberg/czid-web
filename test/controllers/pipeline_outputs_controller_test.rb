...
class PipelineOutputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pipeline_output" do
    assert_difference('PipelineOutput.count') do
      post pipeline_outputs_url, params: { pipeline_output: { remaining_reads: @pipeline_output.remaining_reads, sample_id: @pipeline_output.sample_id, total_reads: @pipeline_output.total_reads } }
    end
