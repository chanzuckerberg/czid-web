...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should get correct report' do
    ...
    assert_equal 2_428_411_411.8, species_result["NR"]["aggregatescore"].round(1)
    ...
    assert_equal 2_428_411_411.8, genus_result["NT"]["aggregatescore"].round(1)
    ...
    assert_equal 2_428_411_411.8, genus_result["NR"]["aggregatescore"].round(1)
    ...
    assert_equal 12_727.05, species_result["NT"]["aggregatescore"].round(2)
    ...
    assert_equal 12_727.05, species_result["NR"]["aggregatescore"].round(2)
    ...
    assert_equal 72_941.946, genus_result["NT"]["aggregatescore"].round(3)
    ...
    assert_equal 72_941.946, genus_result["NR"]["aggregatescore"].round(3)
