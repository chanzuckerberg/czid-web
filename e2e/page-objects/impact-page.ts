...
const COUNTRY_SHOWCASE_ITEM_NAMES =
  "[class*='countryShowcaseContainer'] [class*='countryScrollItem-'] h3";
const COUNTRY_SHOWCASE_TITLE = "[class*='countryShowcaseWindowProjectTitle']";
const COUNTRY_SHOWCASE_DESCRIPTION =
  "[class*='countryShowcaseWindowDescriptionContainer']";
