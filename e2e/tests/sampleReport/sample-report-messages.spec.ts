...
test.describe("Sample Message tests", () => {
  ...
  test(`Should verify Sample Message renders if upload failed`, async ({
    page,
  }) => {
  ...
  test(`Should verify Sample Message renders if workflow failed`, async ({
    page,
  }) => {
  ...
  test(`Should verify Sample Message renders if pipeline is complete with issue`, async ({
    page,
  }) => {
