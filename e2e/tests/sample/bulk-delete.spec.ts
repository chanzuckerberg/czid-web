...
test.describe("Bulk delete samples", () => {
  ...
  test("Should completely delete all my data and runs", async ({ page }) => {
    ...
    await expect(trashIcon.locator("button")).toBeEnabled();
  ...
  test("Should not allow delete of my data and runs", async ({ page }) => {
