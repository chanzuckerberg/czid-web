...
RSpec.describe BenchmarksController, type: :controller do
  ...
  DEFAULT_BENCHMARK_PROJECT = "Bench Project"
  DEFAULT_SAMPLE_NAME = "Sample sample"
  DEFAULT_PIPELINE_VERSION = "5.0"
  ...
  BENCHMARKS_PARSED_JSON = JSON.parse(JSON.generate({
    "active_benchmarks": [
      {
        "comment": "Sample active benchmark 2",
        "frequency_hours": 24,
  ...
  context "Admin user" do
    describe "GET #index" do
      before do
        ...
        create(:project, name: DEFAULT_BENCHMARK_PROJECT, samples_data: [{name: DEFAULT_SAMPLE_NAME, pipeline_runs_data: [{version: DEFAULT_PIPELINE_VERSION}]}])
      end
