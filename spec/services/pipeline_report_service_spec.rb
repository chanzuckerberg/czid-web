...
RSpec.describe PipelineReportService, type: :service do
  ...
  let(:csv_output_mass_normalized_background) { "tax_id,tax_level,genus_tax_id,name,common_name,category,agg_score,max_z_score,nt_z_score,nt_rpm,nt_count,nt_contigs,nt_contig_r,nt_percent_identity,nt_alignment_length,nt_e_value,nt_bg_mean,nt_bg_stdev,nt_bg_mean_mass_normalized,nt_bg_stdev_mass_normalized,nr_z_score,nr_rpm,nr_count,nr_contigs,nr_contig_r,nr_percent_identity,nr_alignment_length,nr_e_value,nr_bg_mean,nr_bg_stdev,nr_bg_mean_mass_normalized,nr_bg_stdev_mass_normalized,species_tax_ids\n570,2,570,Klebsiella,,bacteria,124107.09808698049,0.7071078152481705,0.707106649930723,193750.0,217,6,594,99.7014,149.424,89.5822,96875.0,137002.0,54.25,76.7211,0.7071078152481705,77678.57142857143,87,6,594,97.9598,46.4253,16.9874,38839.3,54927.0,21.75,30.7591,[573]\n573,1,570,Klebsiella pneumoniae,,bacteria,124107.09808698049,0.7071063853398237,0.7071063853398237,186607.14285714287,209,2,198,99.6995,149.402,89.5641,93303.6,131951.0,52.25,73.8927,0.7071063159965896,61607.142857142855,69,2,198,97.8565,46.3623,16.9101,30803.6,43562.8,17.25,24.3952,\n".freeze }
