...
1. decide what docker tag you want to deploy (see https://hub.docker.com/r/chanzuckerberg/idseq-web/tags/). Do not use "branch-master", which is not always what you think it is; choose one of the ones that start with "sha-" and make sure the number is the commit you mean to deploy.
