Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: 'sandbox.idseq.net' }
  ...
  config.action_controller.asset_host = ENV['CLOUDFRONT_ENDPOINT'] || 'sandbox.idseq.net'
  # Custom config for idseq to enable CORS headers by environment. See rack_cors.rb.
  config.allowed_cors_origins = [
    "https://sandbox.idseq.net",
    "https://www.sandbox.idseq.net",
    "https://assets.sandbox.idseq.net",
  ]

  config.middleware.use Rack::HostRedirect, 'www.sandbox.idseq.net' => 'sandbox.idseq.net'
