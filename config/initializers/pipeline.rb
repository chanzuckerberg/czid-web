module IdSeqPipeline
  ...
  S3_HOST_FILTER_SCRIPT_LOC = ENV['IDSEQ_POSTPROCESS_S3_SCRIPT_LOC'] || "s3://czbiohub-infectious-disease/bin/#{Rails.env}/host_filtering.py"
  S3_ALIGNMENT_SCRIPT_LOC = ENV['IDSEQ_POSTPROCESS_S3_SCRIPT_LOC'] || "s3://czbiohub-infectious-disease/bin/#{Rails.env}/non_host_alignment.py"
end
