module ReportHelper
  ...
  def resolve_params(params, view_level_str, data_ranges)
    ...
    [:species_nt_zscore_threshold,
     ...
     "#{view_level_str}_nt_zscore_threshold".to_sym,
     "#{view_level_str}_nt_rpm_threshold".to_sym,
     "#{view_level_str}_nr_zscore_threshold".to_sym,
     "#{view_level_str}_nr_rpm_threshold".to_sym].each do |k|
