class SamplesController < ApplicationController
  ...
  def samples_params
    new_params = params.permit(samples: [:name, :project_id, :status, :host_genome_id, :host_genome_name, :basespace_dataset_id, :basespace_access_token, :skip_cache, :do_not_process, :use_step_function_pipeline,
  ...
  def sample_params
    permitted_params = [:name, :project_name, :project_id, :status,
                        ...
                        :basespace_dataset_id, :basespace_access_token, :client, :do_not_process, :use_step_function_pipeline,
                        input_files_attributes: [:name, :presigned_url, :source_type, :source, :parts],]
