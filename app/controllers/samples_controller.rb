class SamplesController < ApplicationController
  ...
  PUBLIC_NCOV_ENDPOINTS = [
    :index_v2, :dimensions, :stats, :samples_going_public, :search_suggestions, :report_v2, :report, :show_v2, :show, :show_taxid_alignment_viz, :coverage_viz_summary, :coverage_viz_data, :metadata, :metadata_fields, :results_folder,
    :report_csv,
  ].freeze
