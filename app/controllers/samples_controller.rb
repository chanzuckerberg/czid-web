class SamplesController < ApplicationController
  ...
  def show
    ...
    first_pipeline_run = nil
    if @sample.pipeline_runs.first
      first_pipeline_run = @sample.pipeline_runs.select('created_at, finalized,
        id, unmapped_reads, total_reads, sample_id, remaining_reads, job_status,
        updated_at').first
    end
