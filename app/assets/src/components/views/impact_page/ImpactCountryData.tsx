export const ImpactCountryData = [
  {
    countryName: "Brazil",
    principalInvestigator: "Federico Costa, Fiocruz",
    projectTitle:
      "Setting Up Infectious Disease Surveillance Systems in Brazil",
    institution: "Fiocruz",
    summary: `Rapid urbanization in Salvador, a metropolitan of nearly 3 million inhabitants in Northeast Brazil, has produced a favorable environment for the emergence and spread of infectious diseases, including the recent Zika epidemic. This project will focus on collecting clinical samples from patients with suspected infections at a local infectious disease reference hospital and a maternity unit and leverage CZ ID to identify emerging pathogens.
    `,
    cycle: 1,
    mapPosition: {
      bottom: "32%",
  ...
  },
  {
    ...
    principalInvestigator:
      "Ida Kolte, National School of Public Health Sergio Arouca, Oswaldo Cruz Foundation",
    projectTitle:
    ...
    summary: `In 2017-19, 8.5% of all deaths among Indigenous community members in Brazil did not have a registered cause — which is double the proportion observed in the non-Indigenous population. Many of Brazil’s Indigenous communities live in close proximity to wild and domestic animals and in precarious circumstances with food insecurity and limited access to sanitation — creating an optimal environment for transmission of infectious diseases and for potential co-infections. Additionally, Indigenous patients never receive a laboratory-confirmed diagnosis, leading to increasing numbers of avoidable deaths. This project will leverage metagenomics and CZ ID to identify pathogens and co-infections and strengthen clinical diagnostic pathways.
    `,
    cycle: 2,
    mapPosition: {
      bottom: "32%",
  ...
  },
  {
    ...
    summary: `Bolivia has faced emerging, re-emerging, and endemic zoonotic diseases due to a variety of environmental factors. Surveillance, identification, and monitoring of zoonotic pathogens in wildlife and domestic animals are central to the detection and early recognition of emerging diseases that can affect Bolivia and the global community. This project will leverage CZ ID to strengthen local and global disease surveillance, support existing research, and improve laboratory capacities for the detection and characterization of viruses with zoonotic potential.
    `,
    cycle: 2,
    mapPosition: {
      bottom: "28%",
  ...
  },
  {
    ...
    summary: `During Cambodia’s worst dengue epidemic, this team documented the full range of pathogens carried by wild mosquitoes and in serum samples from febrile patients in the country’s Kampong Speu province. This pathogen landscaping study revealed a complex and diverse set of pathogens in Cambodia. It also demonstrated how genetic changes in dengue virus can lead to large outbreaks. This team will continue pathogen surveillance using CZ ID to develop a comprehensive landscape of endemic, zoonotic, or emerging pathogens to inform the country’s public health response.
    `,
    cycle: 2,
    mapPosition: {
      bottom: "41.5%",
  ...
  },
  {
    ...
    projectTitle:
      "Metagenomic Tools to Redefine the Etiology of Pediatric Meningitis in the African Meningitis Belt",
    institution: "Centre Suisse de Recherches Scientifiques",
  ...
  },
  {
    ...
    summary: `Febrile illnesses, which are common among children in the coastal and western regions of Kenya, are caused by diverse microbial pathogens. Patients, despite having no confirmed diagnosis, are almost always treated with broad spectrum antibiotics — without regard to increasing development of drug resistance. This project will leverage CZ ID to identify the etiology, or cause, of febrile-illness not associated with malaria, chikungunya and dengue through ongoing surveillance.
    `,
    cycle: 2,
    mapPosition: {
      bottom: "36.5%",
  ...
  },
  {
    ...
    projectTitle:
      "Development of a Metagenomics Enrichment Method and Characterization of Viral Pathogens in Arbovirus and Viral Haemorrhagic Fever-suspect Samples from Kenya",
    institution: "Kenya Medical Research Institute",
    summary: `Kenya has experienced numerous outbreaks caused by arboviruses and other viral infectious pathogens over the last decade. This study will develop a targeted viral enrichment protocol for metagenomic sequencing of both known and novel arbovirus and viral hemorrhagic fever pathogens, and researchers will apply this protocol with CZ ID to screen and characterize pathogenic viruses in samples from surveillance.
    `,
    cycle: 2,
    mapPosition: {
      bottom: "35.5%",
  ...
  },
  {
    ...
    projectTitle:
      "Development of a Metagenomics Enrichment Method and Characterization of Viral Pathogens in Arbovirus and Viral Haemorrhagic Fever-suspect Samples from Kenya",
    institution: "Pasteur Institute of Madagascar",
  ...
  },
  {
    ...
    summary: `Neuroinfection occurs when bacteria, viruses, fungi, or parasites attack the brain and/or spinal cord, which can lead to long-term disability and death. The causes of 60-80% cases of neuroinfection remain unknown, especially as commercial diagnostic tests often do not detect diseases seen in developing countries, including mosquito-borne viruses like dengue and chikungunya viruses, infections of animal origin such as Leptospira, and newly emerging or re-emerging pathogens like Zika virus. This project will use metagenomic sequencing with CZ ID to identify and characterize a broad range of existing and emerging infectious diseases in a tropical setting.`,
    cycle: 2,
    mapPosition: {
      bottom: "37%",
      left: "74.5%",
  ...
  {
    countryName: "Nepal",
    principalInvestigator: "Rajeev Shrestha, Kathmandu University",
  ...
  },
  {
    ...
    principalInvestigator: "Shabir Madhi, Wits Health Consortium",
    projectTitle:
      "Identifying the Underlying Cause of Stillbirths and Neonatal Deaths in South Africa",
    institution: "Wits Health Consortium",
    summary: `Globally, there are around 2.5 million neonatal deaths and 2.6 million stillbirths annually — the vast majority occurring in low- to middle-income countries. Conventional methods have shown that infectious pathogens cause far more of these deaths than previously thought, and that many cases are linked to multi-drug resistant, hospital-acquired infections. This project will apply CZ ID to archived blood samples from stillbirths and analyze the results to identify novel, unculturable or untargeted pathogens that were not identified using  more traditional microbiological methods.`,
    cycle: 1,
    mapPosition: {
      bottom: "18%",
      left: "53%",
  ...
  },
  {
    ...
    publications: [
      {
        src: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7774551/",
      },
    ],
    prevCountryIndex: 18,
  },
