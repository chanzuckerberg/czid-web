export const ImpactCountryData = [
  ...
  },
  {
    ...
    summary: `Meningitis is a severe infection of the brain and its protective layers — and the most severe forms are caused by bacteria. Every year, around 10.6 million cases and 288,000 deaths are reported globally and more than half occur below the Sahara in a region called the African Meningitis Belt (AMB). Since national disease surveillance only focuses on the detection of four main meningitis pathogens by PCR (meningococcus, streptococcus, GBS and saemophilus influenzae), other causative pathogens are detected in less than 20% of cerebral spinal fluid samples. This study will use CZ ID to determine etiology and will build a collaboration between Swiss Centre for Scientifique Research, the National Meningitis Reference Laboratory in Côte d’Ivoire, the Centre for Vaccine Development in Mali and the National Institute of Public Health in Guinea.
    `,
    cycle: 2,
    mapPosition: {
      bottom: "39%",
  ...
  },
  {
    ...
    projectTitle:
      "Designing of a Metagenomics Enrichment Method and Characterization of Viral Pathogens in Arbovirus and Viral Haemorrhagic Fever-Suspect Samples from Kenya",
