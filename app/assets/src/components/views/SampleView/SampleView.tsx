...
const SampleView = ({
  ...
  useEffect(() => {
    ...
    // We only want to show this warning once per page load so no need to track dependancies.
  ...
  useEffect(() => {
    // We need to be able to cancel the fetch if the component unmounts. This is why we use cancellablePromise.
