...
export const OUTBREAK_DETECTION_OPTION =
...
export const MICROBIOME_ANALYSIS_OPTION = "Conduct Microbiome analysis";
export const SURVEILLANCE_OF_VECTORS_OPTION =
  "Surveillance of vectors (i.e. mosquitoes) or animal reservoirs (i.e. bats)";
export const AMR_DETECTION_OPTION = "Detect AMR-related sequences";
...
export const PHYLOGENETIC_TREE_OPTION = "Build phylogenetic trees";
export const TRAIN_OTHERS_OPTION =
