    ...
    return (
      <NarrowContainer className={cs.termsOfUse} size="small">
        ...
        <List
          listItems={[
            <React.Fragment key={nanoid()}>
              We clarified that the purpose of IDseq is for research purposes
              only and{" "}
              <u>
                is not intended to be used to make decisions regarding health
                care of persons.
              </u>
            </React.Fragment>,
        ...
        <List
          ...
          and/or deleted from IDseq.`,
            <React.Fragment key={nanoid()}>
              ...
              <b>
                after 1 year of it being uploaded unless you take action to
                remove it
              </b>
        ...
        <List
          listItems={[
            <React.Fragment key={nanoid()}>
              We clarified that when we provide notice of changes to our Terms
              of Use, that we will attempt to provide notice <b>before</b> the
        ...
        <List
          listItems={[
            <React.Fragment key={nanoid()}>
              ...
              mutually agree that arbitration is the most effective way to
              settle our dispute, but under the revised terms, you will no
              longer be obligated to <b>only</b> seek remedies in arbitration --
              you can now have any dispute resolved through court.
            </React.Fragment>,
          ]}
        />
        <h3>
        ...
        <List
          listItems={[
            ...
            <React.Fragment key={nanoid()}>
              ...
              . We seek to filter out human data from the data that is uploaded
              by our Users.
            </React.Fragment>,
            `We added more clarity by providing new and more nuanced definitions
          of the types of data that IDseq processes. We have retired the broad
        ...
        <List
          ...
          share your data with.`,
            <React.Fragment key={nanoid()}>
              ...
              Data” will automatically become visible to other Users of IDseq.
              All Users of IDseq will be able to access and use this data{" "}
              <b>
                after 1 year of it being uploaded unless you take action to
                remove it
              </b>
        ...
        <List
          ...
          operation of IDseq, including providing more information in our FAQ.`,
            <React.Fragment key={nanoid()}>
              In the unlikely event we stop providing the IDseq service, we
              added that we will let you know <b>before</b> we allow another
              entity to take over its development and operation and that we will
              require that the third party be bound by the Data Privacy Notice
              and Terms of Use.
            </React.Fragment>,
          ]}
        />
        ...
        <List
          listItems={[
            <React.Fragment key={nanoid()}>
              We added that we will provide you notice of any material changes
              to the Privacy Notice <b>before</b> they become effective.
            </React.Fragment>,
          ]}
        />
      </NarrowContainer>
