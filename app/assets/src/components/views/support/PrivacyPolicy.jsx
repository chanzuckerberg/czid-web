...
const PrivacyPolicy = () => {
  const renderIntro = () => (
    <>
      ...
      <p>
        ...
        &quot; us,&quot; or &quot;our&quot;) provides the Chan Zuckerberg ID
        platform (&quot;Services&quot; or &quot;CZ ID&quot;) in partnership with
        the Chan Zuckerberg Initiative, LLC (&quot;CZI&quot;). This Data Privacy
        Notice (&quot;Privacy Notice&quot;) describes the types of information
        ...
        <tbody>
          ...
          <tr className={cs.contentRow}>
            ...
            <td>
              ...
              microorganisms in your sample. These can be shared with other CZ
              ID users.
            </td>
            <td>
            ...
            <td>
              <div>
                ...
                <p>
                  ...
                  Service Providers (ex: AWS) that help operate and secure CZ
                  ID.
                </p>
                <br />
                <p>
          ...
          <tr className={cs.contentRow}>
            ...
            <td>
              ...
              Information (ex: links within CZ ID you click on and how often you
              log into CZ ID) includes basic information about how Users and
              Visitors are interacting with CZ ID.
            </td>
            <td>See above.</td>
            <td>See above.</td>
          </tr>
  ...
  const renderAboutCZID = () => (
    <>
      ...
      <p>
        CZ ID also collects information about Users in order to offer the
        ...
        want to upload onto CZ ID. Please note: CZ ID is not designed for or
  ...
  const renderUploadDataPolicy = () => (
    <>
      ...
      <p>
        ...
        that uploaded the Sample. Even staff working on CZ ID cannot access this
      ...
      <p>
        ...
        dashboard for researchers, Report Data and Sample Metadata will be made
        available to <b>all CZ ID users</b> 1 year after Raw Sample Data is
        uploaded. Before this 1-year anniversary of upload, Users can also
        choose to share their Report Data and Sample Metadata by creating
        Projects (groups of Reports) and sharing those Projects with other CZ ID
        users.
      </p>
      <p>
  ...
  const renderReportDataPolicy = () => (
    <>
      ...
      <p>
        ...
        Report Data (including Sample Metadata) is visible to all CZ ID Users,
        and they may share it with others beyond CZ ID. This <b>does not</b>{" "}
    ...
    <>
      ...
      <List
        listItems={[
          ...
          `To analyze how Users and Visitors are using CZ ID so we can optimize
        and improve it.`,
  ...
  const renderInformationProtectionPolicy = () => (
    <>
      ...
      <p>
        ...
        uploaded the Sample. Even staff working on CZ ID cannot access this
        information except as specifically instructed by a User, such as to
        debug an issue.
      </p>
      <p>
