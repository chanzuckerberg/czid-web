        ...
        <div className="bulletin-banner">
          <Container>
            ...
            <div className="bulletin-description">
              Journey to the frontlines of global health with a public showcase
              site. Read how researchers in Cambodia detected the SARS-CoV-2
              virus using IDSeq technology, and explore sample data generated by
              IDSeq.
            </div>
            <ExternalLink
              href="https://public.idseq.net/"
              analyticsEventName="Landing_public-idseq-link_clicked"
            >
              <TransparentButton text="Explore the COVID-19 Public Dataset" />
            </ExternalLink>
          </Container>
        </div>
      );
