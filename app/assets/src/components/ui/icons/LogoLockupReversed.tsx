...
const LogoLockupReversed = (props: IconTextProps) => {
  return (
    <svg
      ...
      <g
        id="Logo-/-Lockups-/-LogoLockupReversed"
        stroke="none"
        strokeWidth="1"
        fill="none"
        fillRule="evenodd">
...
LogoLockupReversed.defaultProps = {
  text: "Tool Name",
};

export default LogoLockupReversed;
