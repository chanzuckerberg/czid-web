class UserMailer < ApplicationMailer
  def added_to_projects_email(new_user_id, email_arguments)
    ...
    LogHelper.log_err_and_airbrake("added_to_projects_email(#{email_arguments}) failed")
  end
  ...
  def project_complete_email(email_arguments)
    ...
    LogHelper.log_err_and_airbrake("project_complete_email(#{email_arguments}) failed")
  end
end
