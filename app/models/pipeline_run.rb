...
class PipelineRun < ApplicationRecord
  ...
  def load_results_from_s3
    ...
    byteranges_json_s3_path = "#{sample.sample_output_s3_path}/#{TAXID_BYTERANGE_JSON_NAME}"
    # Get the file
    ...
    pipeline_output_dict['taxon_sequence_locations_attributes'] = byteranges_array
