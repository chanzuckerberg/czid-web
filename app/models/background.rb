class Background < ApplicationRecord
  ...
  # This set of ten backgrounds was generated by SQL analysis of sample page
  # requests for the purpose of precache_report_info. The top 1 accounts for
  # 52% of unique users, top 5 accounts for 71%, and top 10, 83%.
  TOP_BY_USAGE = [
    93,
    26,
    27,
  ...
  def self.top_by_usage
    Background.where(id: TOP_BY_USAGE)
  end
